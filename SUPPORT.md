...
`foundry-sample-threat-intel` is a community-driven, open source project which serves as an example of an app which can be built using CrowdStrike's Foundry ecosystem.
...
Issues may be reported [here](https://github.com/CrowdStrike/foundry-sample-threat-intel/issues/new/choose) and are used to track bugs, documentation and link updates, enhancement requests and security concerns.
...
[![Report Issue](https://raw.githubusercontent.com/CrowdStrike/falconpy/main/docs/asset/report-issue.png)](https://github.com/CrowdStrike/foundry-sample-threat-intel/issues/new/choose)
